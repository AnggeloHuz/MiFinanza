...
import { createCredito } from '../../database/database';

export default function CreditoFormView({ isDark, userId, onBack, onSaved }) {
  ...
  // Manejar el formato de la fecha DD/MM/AAAA
  ...
  const handleSave = async () => {
    if (!nombre.trim()) {
      Alert.alert('Error', 'Debe ingresar un nombre o descripción del crédito.');
      return;
    }
    ...
    // Registrar en BD
    const response = await createCredito(userId, entidad, nombre, fechaVisual, monto, moneda, descripcion);
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.fieldContainer}>
          ...
          <TextInput
            ...
            placeholder="Ej. Juan Pérez, Banco X..."
        ...
        <View style={styles.fieldContainer}>
          ...
          <TextInput
            ...
            placeholder="Detalles sobre este crédito..."
            placeholderTextColor={theme.placeholder}
            value={descripcion}
        ...
        <TouchableOpacity style={[styles.saveBtn, { backgroundColor: theme.accent }]} onPress={handleSave}>
          ...
          <Text style={styles.saveBtnText}>Guardar Crédito</Text>
        </TouchableOpacity>
